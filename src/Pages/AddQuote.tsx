import { FormType, NewAuthor, NewQuote, Quote } from "../myTypes";
...
export default function AddQuote({ quotes, setQuotes }: Props) {
    ...
    function createQuote(formData: any) {
    ...
    function createAuthor(formData: NewAuthor) {
        ...
        <div className="modal">
            <form className="quote-form"
                onSubmit={(e: React.SyntheticEvent) => {
                    ...
                    createAuthor(dataForAuthor)
                    createQuote(dataForQuote)
                    formEl.reset()
                }}
            >
